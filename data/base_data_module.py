...
class BaseDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args: argparse.Namespace = None) -> None:
        ...
        self.dev_batch_size = self.args.get("dev_batch_size", BATCH_SIZE)
    ...
    def add_to_argparse(parser):
        ...
        parser.add_argument(
            "--dev_batch_size", type=int, default=BATCH_SIZE, help="Number of examples to operate on per forward step."
        )
        parser.add_argument(
    ...
    def val_dataloader(self):
        return DataLoader(self.data_val, shuffle=False, batch_size=self.dev_batch_size, num_workers=self.num_workers, pin_memory=True)
